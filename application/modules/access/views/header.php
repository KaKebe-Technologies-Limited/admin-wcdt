        ...
        <div id="scroll-element" class="header_section <?php if ($home == false) { echo "header_sec_bg"; } ?>">
            <div class="container">
                <div class="col-md-1 col-sm-1 col-xs-1 logo">
                    <img src="<?php echo base_url();?>assets/assets/images/website/paglogo.png" height="60px" width="auto" alt="<?php echo $basic->title;?>"></img>
                </div>
                          ...
                          <ul class="nav navbar-nav">
                            ...
                            <?php }  if($home == true){ ?>
                                ...
                                <li class="parent-menu donation">
                                    <a data-toggle="modal" class="donatePhone" width="100%" data-target="#donationModal"><i class="fa fa-heart"></i> Donate</a>
                                </li>
